...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * If the user_head_default presses Back, the result code will be {@link android.app.Activity#RESULT_CANCELED}.
         */
    ...
    public static final class Encode {
        ...
        /**
         * Normally the contents of the barcode are displayed to the user_head_default in a TextView. Setting this
    ...
    public static final class Share {
        /**
         * Give the user_head_default a choice of items to encode as a barcode, then render it as a QR Code and
