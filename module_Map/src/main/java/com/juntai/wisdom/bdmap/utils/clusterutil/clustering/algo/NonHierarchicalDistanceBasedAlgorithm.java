...
package com.juntai.wisdom.bdmap.utils.clusterutil.clustering.algo;
...
import com.juntai.wisdom.bdmap.utils.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.juntai.wisdom.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.juntai.wisdom.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.juntai.wisdom.bdmap.utils.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.juntai.wisdom.bdmap.utils.clusterutil.clustering.algo
